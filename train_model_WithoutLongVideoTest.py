...
history, model = main(video_dir = 'DCSASS Dataset/', result_dir = 'output/', nb_classes = 14, batch_size = 8, epochs = 2, img_size = 224, frames = 25)
...
# mm.save('output/slowfast_finalmodel_New.hd5')
## LOAD MODEL ##
